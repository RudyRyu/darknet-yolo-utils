...
parser.add_argument('--dataset_path', type=str, help='path to PascalVOC dataset, default=%(default)s', default='../../dataset/VOCdevkit')
parser.add_argument('--year', type=str, help='subset path of year (2007/2012), default will cover both', default='2012')
parser.add_argument('--set', type=str, help='convert data set, default will cover train, val and test', default=None)
parser.add_argument('--output_path', type=str,  help='output path for generated annotation txt files, default=%(default)s', default='../../dataset/VOCdevkit/VOC2012')
